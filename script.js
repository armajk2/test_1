    ...
    container.innerHTML = posts.map(post => `
            <div class="post">
                <div class="post-header">
                    <div>
                    ${isLoggedIn ? 
                        `<strong class="username-link" onclick="showUserProfile('${post.author?.user_id || post.user_id}', '${post.author?.username || post.username || '사용자'}')">${post.author?.username || post.username || '사용자'}</strong>` :
